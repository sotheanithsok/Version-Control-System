...
export const directoriesReducer: Reducer<IDirectoriesState, IDirectoriesActions> = (directoriesState: IDirectoriesState = initialDirectoriesState, action: IDirectoriesActions) => {
    switch (action.type) {
